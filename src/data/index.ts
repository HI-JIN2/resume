...
export const ABOUT_ME = [
  "서비스를 끝까지 책임지는 안드로이드 개발자입니다. 학식 리뷰 앱 EAT-SSU를 2년 7개월간 운영하며 3,500명 규모 서비스의 품질과 사용자 경험을 직접 책임졌고, CS/피드백 반영, UI/UX 개선, XML에서 Compose로의 전환, 플레이스토어 정책 대응까지 운영-개선-업데이트 사이클을 반복했습니다.",
  "운영 고도화를 통해 핵심 지표를 개선했습니다. 전년 대비 WAU/MAU가 21.8%에서 62.4%로 상승해 주간 재방문율과 서비스 Stickiness를 크게 끌어올렸습니다.",
  "기술로 실질적인 문제를 빠르게 해결합니다. 해외 봉사 중 500권 도서를 전산화해야 하는 상황에서 4시간 만에 안드로이드 바코드 스캔 시스템을 만들어 수작업 대비 6배 효율을 냈습니다.",
  "함께 성장하는 문화를 만들었습니다. 전공 프로젝트였던 EAT-SSU 팀을 3명에서 15명 규모로 확장하며 지원자-팀 커피챗을 도입해 서로의 니즈를 맞추고, 세미나·KPT 회고·안드로이드 코드 리뷰 문화를 정착시켰습니다.",
  "Google Developer Student Clubs에서 2년간 활동하며 CS 인터뷰 스터디, 회고 모임, 테크 블로그 모임을 운영해 '스터디를 가장 많이 운영한 멤버'로 선정됐습니다.",
];
    ...
    features: [
      {
        ...
        to: "2024.12",
        description:
          "BLE Advertising과 Compose 애니메이션으로 전기자전거 주행 환경을 시뮬레이션하는 데모 앱 개발",
        achievements: [
      ...
      {
        title: "trimm Cycling Center 앱 신기능 개발",
        from: "2024.09",
        to: "2024.12",
        description:
...
export const PERSONAL_PROJECT: PersonalProject[] = [
  {
    ...
    feature: {
      ...
      descriptions: [
        ...
        "Glance 위젯 + WorkManager + DataStore를 결합해 식당 위젯 자동 업데이트와 사용자 커스터마이징 기능 구현",
      ],
    },
  },
  {
...
export const OPEN_SOURCE_PROJECT: OpenSourceProject[] = [
  ...
  },
  {
    ...
    feature: {
      title: "학력 및 교내 수상",
      descriptions: [
        "숭실대학교 컴퓨터학부 학사 (2021.03 - 2025.08) · ICT 유통물류 융합전공 이수",
        "15회 숭실 캡스톤디자인 경진대회 장려상 (2025.10), 소프트웨어공모전 은상 (2025.07), 금상 (2023.08)",
      ],
    },
  },
  {
