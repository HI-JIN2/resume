...
export const ABOUT_ME = [
  "서비스를 끝까지 책임지는 안드로이드 개발자입니다.",
  "학식 리뷰 앱 EAT-SSU를 2년 7개월간 운영하며 3,500명 규모 서비스의 품질과 사용자 경험을 직접 책임졌고, \n CS/피드백 반영, UI/UX 개선, XML에서 Compose로의 전환, 플레이스토어 정책 대응까지 운영-개선-업데이트 사이클을 반복했습니다.",
